                    ...
                    <div className="col-md-12">
                        <div className="text-title-inner">
                            <div className="desc-card">
                                <p>
                                    THE African Association of Automotive Manufacturers, AAAM, and the African Continental Free Trade Area, AfCFTA, Secretariat are hosting a webinar to explore how the AfCFTA is helping to shape the automotive policies for Africa which, in turn, drives industrialisation. Also to be discussed during the free virtual event is why the Rules of Origin are key in driving investment and confidence in Africa.
                                </p>
                                <p>
                                    “We believe that all automotive industry role players, including policy advisors, business leaders and potential investors will gain great insight from the event as we unpack various aspects of the potential of the African market and the opportunities it provides.
                                </p>
                                <p>
                                    “We applaud the African Union for launching the AfCFTA; this is the largest free trade bloc in terms of participating countries and will provide the scale that is required for a globally competitive African automotive sector,” says David Coffey, the CEO of AAAM.
                                </p>
                                <p>
                                    “The political will is required to put significant policy reforms and trade facilitation measures in place to realise the benefit of the AfCFTA”
                                ...
                                <p>
                                    Of particular interest will be a discussion on the fast-tracking of the conclusion of the automotive Rules of Origin.
                                </p>
                                <p>
...
export default NewsDetailSection6;
